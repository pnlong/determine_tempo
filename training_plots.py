...
# sys.argv = ("./training_plots.py", "/dfs7/adl/pnlong/artificial_dj/data/tempo_nn.pretrained.history.tsv", "/dfs7/adl/pnlong/artificial_dj/data/tempo_nn.pretrained.percentiles_history.tsv", "/dfs7/adl/pnlong/artificial_dj/data/tempo_nn.pretrained.png")
##################################################
