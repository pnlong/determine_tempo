...
Ultimately, I decided on the Window Method, using a 10 second window. A new window begins every 5 seconds. The trained neural network can be found at [this link](https://drive.google.com/file/d/18D2ocW4iygeg4DA2c4j4yWzxTNa7p4Dg/view?usp=sharing).
